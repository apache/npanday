...
namespace NMaven.ProjectImporter.ImporterTests
{
    public abstract class AbstractProjectImportTest
    {
        ...
        public void ShouldBeAbleImportProject()
        {
            ...
            try
            {
                generatedPomFiles = NMavenImporter.ImportProject(solutionFile, GroupId, ArtifactId, "1.2.3-SNAPSHOT", false);
        ...
        public void ShouldBeAbleToReImportProject()
        {
            try
            {
                ...
                generatedPomFiles = NMavenImporter.ReImportProject(solutionFile);
