...
namespace NMaven.ProjectImporter.Verifiers
{
    public class VerifyProjectImportSyncronization
    {
        ...
        private static void SyncProjectValues(ref ProjectDigest projectDigest)
        {
            ...
            NMaven.Model.Pom.Model model = NMaven.Utils.NMavenPomHelperUtility.ReadPomAsModel(pomFile);
        ...
        static void SyncParentValues(ProjectStructureType structureType, string solutionFile, ref string groupId, ref string artifactId, ref string version)
        {
            ...
            NMaven.Model.Pom.Model model = NMaven.Utils.NMavenPomHelperUtility.ReadPomAsModel(parentPomFile);
        ...
        static bool IsProjectAnIntegrationTest(NMaven.Model.Pom.Model model)
        {
        ...
        static Plugin FindPlugin(NMaven.Model.Pom.Model model, string groupId, string artifactId)
        {
            return FindPlugin(model, groupId, artifactId, null);
        }

        static Plugin FindPlugin(NMaven.Model.Pom.Model model, string groupId, string artifactId, string version)
        {
