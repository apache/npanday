...
namespace NMaven.ProjectImporter.Converter.Algorithms
{
    public abstract class AbstractPomConverter : IPomConverter
    {
        ...
        protected NMaven.Model.Pom.Model parent;
        ...
        protected NMaven.Model.Pom.Model model;

        public NMaven.Model.Pom.Model Model
        {
            get { return model; }
        }


        public AbstractPomConverter(ProjectDigest projectDigest, string mainPomFile, NMaven.Model.Pom.Model parent, string groupId)
        {
            ...
            this.model = new NMaven.Model.Pom.Model();
            // Add build Tag
            this.model.build = new NMaven.Model.Pom.Build();
        ...
        protected void GenerateHeader(string packaging)
        {
            ...
            if (parent != null)
            {
                model.parent = new NMaven.Model.Pom.Parent();
                ...
                if (!string.IsNullOrEmpty(mainPomFile))
                {
                    ...
                    model.parent.relativePath = NMavenPomHelperUtility.GetRelativePath(dir, file);
                }
            }
            else
            {
        ...
        protected string GetSourceDir()
        {
            ...
            foreach (Compile compile in projectDigest.Compiles)
            {
                ...
                common = NMavenPomHelperUtility.GetCommonDirectory(common, srcInclude);
            ...
            string srcDir = NMavenPomHelperUtility.GetRelativePath(prjDir, common);
