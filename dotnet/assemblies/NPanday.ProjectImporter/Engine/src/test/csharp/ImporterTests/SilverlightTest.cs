...
{
    [TestFixture]
    public class SilverlightTest : AbstractProjectImportTest
    {
        ...
        {
            get { return @"SilverlightApplication1\SilverlightApplication1.sln"; }
        }

        [Test]
        public override void ShouldGenerateTheExpectedNumberOfPoms()
        {
            ProjectImporterAssertions.AssertPomCount(5, GeneratedPomFiles);
        }

        public override string TestResourcePath
        {
            get { return @"src\test\resource\SilverlightApplication1\"; }
        }
    }
}
